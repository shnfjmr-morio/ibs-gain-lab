...
export default function WeightPage() {
  ...
  const inputCls = 'w-full border border-gray-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-emerald-400'
      ...
      >
        <div className="space-y-4 pb-2">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input type="text" value={notes} onChange={e => setNotes(e.target.value)}
                placeholder="今日の気づきなど" className={inputCls} />
            </div>
          </div>
          ...
          <motion.button
            ...
            transition={{ type: 'spring', stiffness: 400, damping: 25 }}
            className="w-full bg-emerald-600 text-white rounded-2xl py-3.5 font-semibold disabled:opacity-40 shadow-[0_4px_14px_rgba(61,143,133,0.3)]"
          >
            {t('weight.save')}
          </motion.button>
        </div>
